...
<header class="intro">
  ...
  <p>My research interests lie broadly in <strong>LLM-based agents</strong>, with particular interests in <strong>self-improving agentic systems</strong>, <strong>harness optimization</strong>, <strong>LLM post-training</strong>, and <strong>retrieval-augmented generation (RAG)</strong>. My recent work on GUI agents includes <a class="intro-jump" href="{{ '/projects/harnessgrad/' | relative_url }}"><strong>GUI-HarnessGrad</strong></a>, a failure-driven algorithm that learns from execution feedback to improve the harness around a fixed model.</p>
  <p>I also enjoy turning technical ideas into usable systems. My work includes the <a class="intro-jump" href="{{ '/projects/voice-turing/' | relative_url }}"><strong>Voice Turing Test</strong></a>, a public WeChat game and ICLR 2026 research data platform, and <a class="intro-jump" href="{{ '/projects/telos/' | relative_url }}"><strong>Telos</strong></a>, a goal-driven product for converting fragmented resources into ready-to-learn courses.</p>
  <p>Beyond my individual projects, I was the modeling and programming lead for a team in the <a class="intro-jump" href="{{ '/projects/mcm-2026/' | relative_url }}"><strong>Mathematical Contest in Modeling (MCM) 2026</strong></a>, receiving the <strong>Finalist (F Award, top 1%)</strong> distinction. I have also served as a <strong>Teaching Assistant</strong> for Calculus I at CUHK-Shenzhen. Outside work, I enjoy <strong>photography</strong>, <strong>piano</strong>, <strong>drawing</strong>, and <strong>hiking</strong>.</p>
